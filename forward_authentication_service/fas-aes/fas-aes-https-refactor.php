...
#############################################################################################################
#
# Send The Auth List to openNDS
#
# When a client has been verified, their parameters are added to the "auth list"
...
function write_log() {
	...
	$log=date('Y-m-d H:i:s', $_SERVER['REQUEST_TIME']).
		", $me, $gatewayname, $fullname, $email, $clientip, $clientmac, $clientif, $user_agent, $originurl\n";
