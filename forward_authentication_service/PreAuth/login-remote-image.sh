...
# This example version based on the standard login.sh script shows how to incorporate a remote image.
#
##########################################################################################
# Note for remote image support:
...
# The image is placed in the splash page footer html generated by the function footer()
# and is downloaded by get_image_file() to the router the first time a client connects.
# It is stored on a tmpfs directory so does not survive a reboot.
# Walled Garden configuration is NOT required.
##########################################################################################
...
############## Example image number 1 ##############
#imageurl="http://avatars1.githubusercontent.com/u/62547912"
#imagetype="png"

############## Example image number 2 ##############
imageurl="http://cdn.pixabay.com/photo/2015/11/10/08/31/banner-1036483_960_720.jpg"
imagetype="jpg"
