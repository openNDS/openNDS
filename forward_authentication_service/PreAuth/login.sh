...
# See end of file for a programming guide.
...
thankyou_page () {
	...
	echo "<big-red>Thankyou for using this service!</big-red>"
...
name_email_login() {
	...
	echo "<big-red>Welcome!</big-red><br>
		...
		<italic-black>To access the Internet you must enter your full name and email address then click Continue to proceed.</italic-black><hr>"
	echo -e "$form"
...
click_to_continue() {
	...
	echo "<big-red>Welcome!</big-red><br>
		<med-blue>You are connected to $client_zone</med-blue><br>
		<italic-black>To access the Internet you must click Continue to proceed.</italic-black><hr>"
	echo -e "$form"
...
if [ ! -z "$status_present" ]; then
	...
	queryvarlist="clientip gatewayname hid gatewayaddress redir username emailaddr continue"
fi

#Populate querylist variables from data in the query string
